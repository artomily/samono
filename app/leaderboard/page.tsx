      ...
      <div className="mx-auto max-w-3xl">
            ...
            <div className="flex items-end justify-center gap-4">
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                >
                  ...
                  <p className="text-[11px] text-cyan-300/70 mt-1 font-mono">
                    {tableEntries[1].total_earned.toFixed(2)} BNB
                  </p>
                </div>
              </div>
              {/* 1st place */}
              <div className="flex flex-col items-center gap-2">
                ...
                >
                  ...
                  <p className="text-[11px] text-pink-300 mt-1 font-mono">
                    {tableEntries[0].total_earned.toFixed(2)} BNB
                  </p>
                </div>
              </div>
              {/* 3rd place */}
              <div className="flex flex-col items-center gap-2">
                ...
                >
                  ...
                  <p className="text-[11px] text-cyan-300/70 mt-1 font-mono">
                    {tableEntries[2].total_earned.toFixed(2)} BNB
                  </p>
                </div>
              </div>
            </div>
        ...
        {tableEntries.length === 0 && (
          <div className="border border-white/10 py-20 text-center">
            ...
            <p className="text-sm text-white/25">Be the first to earn BNB rewards!</p>
          </div>
        )}
      </div>
    </div>
